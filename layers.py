"""
Neural network layers for voxel-conditioned occupancy networks.

This module contains the exact implementations of conditional batch normalization
and ResNet blocks used in the original codebase, preserving all mathematical
computations and parameter structures.
"""
...
class CBatchNorm1d(nn.Module):
    ...
    Exactly replicates the original implementation from im2mesh/layers.py
    ...
    def __init__(self, c_dim, f_dim, norm_method='batch_norm'):
        ...
        # Submodules - exact same as original
...
class CBatchNorm1d_legacy(nn.Module):
    ...
    Exactly replicates the original legacy implementation.
...
class CResnetBlockConv1d(nn.Module):
    ...
    def __init__(self, c_dim, size_in, size_h=None, size_out=None,
        ...
        # Attributes - exact same as original
        if size_h is None:
            size_h = size_in
        if size_out is None:
            size_out = size_in
        ...
        # Initialization - exact same as original
...
class ResnetBlockFC(nn.Module):
    ...
    Exactly replicates the original implementation.
